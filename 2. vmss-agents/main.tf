locals {
  ...
  virtual_machine_scale_set_name           = "${var.project_code}-agent"
  virtual_machine_scale_set_prefix         = "${var.project_code}"
...
SETTINGS
    ...
    {
        "commandToExecute" : "powershell -ExecutionPolicy Unrestricted -File Configure-Agent.ps1",
